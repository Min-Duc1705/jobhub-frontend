...
- 🎯 **Gợi Ý Việc Làm Cá Nhân Hóa (AI Match):** Tự động đề xuất công việc chính xác 100% dựa vào lịch sử thao tác và kỹ năng cốt lõi (Thuật toán Collaborative Filtering).
...
├── pages/                # Các trang chính hiện thị (Auth, Jobs, Company)
